...
ALTER TABLE "person" ADD CONSTRAINT "person_fk1" FOREIGN KEY ("country_id") REFERENCES "countries"("id");
ALTER TABLE "person" ADD CONSTRAINT "person_fk2" FOREIGN KEY ("gender_id") REFERENCES "genders"("id");
ALTER TABLE "person" ADD CONSTRAINT "person_fk3" FOREIGN KEY ("auth_id") REFERENCES "auth"("id");
